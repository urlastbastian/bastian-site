          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-start w-full">
            ...
            <div className="md:pt-10">
              <p className="text-gray-500 text-xl mb-6 leading-relaxed">
                Bastian is the creative agency connecting <strong>ambitious brands</strong> with <strong>specialist freelancers</strong> across India, Southeast Asia, and beyond. We curate your perfect team and manage everything - agency-quality work, startup-friendly cost.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-2">
              <div className="mb-4"><img src="https://tuvojbqvhbitedvgtzjn.supabase.co/storage/v1/object/public/Portfolio/Bastian%20Logo_Fin_Long.png" alt="Bastian - Creative Agency" className="h-8 w-auto object-contain" /></div>
              <p className="text-sm text-gray-400 leading-relaxed max-w-xs mb-6">Your Last Bastian.</p>
              <div className="flex items-center gap-4">
                <a href="https://www.instagram.com/bastianconsultants/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gray-400 hover:text-[#f64523] transition-colors">
                ...
                <a href="https://www.linkedin.com/company/bastianconsultants/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-gray-400 hover:text-[#f64523] transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                </a>
                <a href="https://wa.me/917259803027" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-gray-400 hover:text-[#f64523] transition-colors">
                ...
                <a href="mailto:communication@bastian.co.in" aria-label="Email" className="text-gray-400 hover:text-[#f64523] transition-colors">
